...
#define STRING_CONFIG_H_AUTHOR "Ika108" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  19.798
    #define DEFAULT_Ki   2.441
    #define DEFAULT_Kd  40.140
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.13, 80.18, 402.5, 440 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 50.000, -40.000, 0 }
